...
selected=$(printf '%s\n' "${names[@]}" | tofi --prompt-text "Waydroid Apps" --fuzzy-match true --config ~/.config/tofi/config.conf --prompt-text '' --ascii-input true --padding-left 40% --padding-top 33% --font /usr/share/fonts/TTF/JetBrainsMono-Regular.ttf)
